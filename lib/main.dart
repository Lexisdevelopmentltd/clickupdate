...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    colorSchemeSeed: Color(0xff36C5D3),
        ...
        textTheme: TextTheme(
          headlineSmall: TextStyle(fontSize: 22.0, color: Color(0xff000000), height: 1.3),
          headlineMedium: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w700, color: Color(0xff000000), height: 1.3),
          ...
          displayLarge: TextStyle(fontSize: 26.0, fontWeight: FontWeight.w300, color: Color(0xff000000), height: 1.4),
          titleMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w500, color: Color(0xff000000), height: 1.3),
          titleLarge: TextStyle(fontSize: 17.0, fontWeight: FontWeight.w700, color: Color(0xff000000), height: 1.3),
          bodyMedium: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, color: Color(0xff000000), height: 1.2),
          bodyLarge: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w400, color: Color(0xff000000), height: 1.3),
          bodySmall: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w300, color: Color(0xff000000).withOpacity(0.5), height: 1.2),
        ),
      ),
    );
  }
